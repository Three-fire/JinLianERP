    ...
    if (modalType != undefined) {
        ...
        switch (modalType) {
            ...
            case "AccepterOfOfficer":
                ...
                width = window.innerWidth * 3 / 5;
                height = 80;
                modalIframeSrc = ccbpmPath + "/WF/WorkOpt/AccepterOfOfficer.htm?FK_Node=" + paramData.FK_Node + "&FID=" + paramData.FID + "&WorkID=" + paramData.WorkID + "&FK_Flow=" + paramData.FK_Flow + "&PWorkID=" + GetQueryString("PWorkID") + "&ToNode=" + toNode + "&s=" + Math.random() + "&isFrameCross=" + isFrameCross;
                break;
            case "SelectNodeUrl":
                title = "请选择到达的节点";
