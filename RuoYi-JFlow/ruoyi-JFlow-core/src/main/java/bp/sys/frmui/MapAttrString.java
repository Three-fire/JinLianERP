...
public class MapAttrString extends EntityMyPK
{
	...
	public final void setSupperText(boolean value)  throws Exception
	 {
		this.SetValByKey(MapAttrAttr.IsSupperText, value);
	}

	public final boolean isRichText() throws Exception
	{
		return this.GetValBooleanByKey(MapAttrAttr.IsRichText);
	}
	public final void setRichText(boolean value)  throws Exception
	 {
...
//		map.AddBoolean(MapAttrAttr.IsSecret, false, "是否保密？", true, true);
	...
	/** 
	 ...
	 @return 
	*/
	public final String DoQRCode() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/QRCode.htm?FrmID=" + this.getFK_MapData() + "&MyPK=" + this.getMyPK();
	}
	...
	*/
	...
	/** 
	 ...
	 @return 
	*/
	public final String DoStyleEditer() throws Exception {
		return "../../Admin/FoolFormDesigner/StyletDfine/GloValStyles.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn=" + this.getKeyOfEn();
	}
	...
	*/
	...
	public final String DoSetFlowBBS() throws Exception {
		...
		mapAttrs.Retrieve(MapAttrAttr.FK_MapData, this.getFK_MapData(), MapAttrAttr.UIContralType, UIContralType.FlowBBS.getValue());
		if (mapAttrs.size() == 0)
		{
	...
	*/
	public final String DoMultipleChoiceSmall() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/MultipleChoiceSmall/Default.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn=" + this.getKeyOfEn() + "&m=s";
	}


	public final String DSingleChoiceSmall() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/SingleChoiceSmall/Default.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn=" + this.getKeyOfEn() + "&m=s";
